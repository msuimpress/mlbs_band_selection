...
X=tf.keras.layers.Conv1D(num_bands, 9, activation='relu',padding='Same')(X)
M=tf.keras.layers.GlobalAveragePooling1D(data_format="channels_last")(X)
...
model.save("hbs_cmcnn_" + DATASET_NAME)
